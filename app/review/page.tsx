...
export default function ReviewMode() {
  ...
  const loadReview = async () => {
    try {
      ...
      // Get learned questions (score = 0)
      const learnedQuestions = await db.questions
        .find({
          selector: {
            score: 0,
            ...tagFilter,
      ...
      const learned: QuestionDocument[] = learnedQuestions.map((q) => q.toJSON() as QuestionDocument);
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow text-center">
            <p className="text-xl mb-4">No learned questions to review.</p>
            <p className="text-gray-600">Complete some games to learn questions first.</p>
          </div>
        </div>
      </div>
    );
